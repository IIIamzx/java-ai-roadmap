...
public class AssistantConfig {
    ...
    @Bean
    public ChatAssistantService init(EmbeddingStore<TextSegment> embeddingStore, SearchApiWebSearchEngine engine){
        return AiServices.builder(ChatAssistantService.class)
                ...
                .tools(new CalculatorHighLevel(),new WebSearchTool(engine))
